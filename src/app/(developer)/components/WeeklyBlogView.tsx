...
export default function WeeklyBlogView() {
  ...
  if (loading) {
    return (
      <div className="w-full min-w-0 bg-white rounded-[24px] border border-gray-100 shadow-sm py-24 text-center">
        <div
  ...
  if (!blog) {
    return (
      <div className="w-full min-w-0 bg-white rounded-[24px] border border-gray-100 shadow-sm px-6 sm:px-8 py-16 text-center">
  ...
  return (
    <div className="w-full min-w-0 bg-white rounded-[24px] border border-gray-100 shadow-sm px-6 sm:px-8 py-10">
      ...
      <h1
        className="text-3xl font-bold text-gray-900 mb-6 break-words"
        style={{ fontFamily: "var(--font-fraunces, serif)" }}
      >
        {blog.title}
      </h1>
      <div className="prose prose-sm max-w-none text-gray-600 leading-relaxed whitespace-pre-wrap break-words">
        {blog.content}
      </div>
    </div>
  );
