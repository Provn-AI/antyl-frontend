    ...
    <>
      ...
      <section className={`video-section lazy-section${lazyVideo.visible ? " visible" : ""}`} id="demo-video" ref={lazyVideo.ref}>
        <div className="video-header">
          ...
          <h2 className="section-title blur-reveal">Watch Antyl <em>find your next job</em></h2>
          <p className="section-sub" style={{ margin: "0 auto" }}>
            A 2-minute walkthrough of connecting your GitHub, getting verified, and watching auto-apply run in the background.
          </p>
        </div>
        ...
        <div className="video-meta-row">
          ...
          <span className="video-meta-item"><span className="video-meta-dot" style={{ background: "#FF6B4D" }} />Real GitHub verification flow</span>
          <span className="video-meta-item"><span className="video-meta-dot" style={{ background: "#FFB347" }} />Auto-apply in action</span>
        </div>
      </section>
